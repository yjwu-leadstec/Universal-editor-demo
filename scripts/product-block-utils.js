...
const PRODUCT_MODEL_FIELDS = {
  ...
  'highlight-slide': [['image', 'reference'], ['imageAlt', 'text'], ['mobileImage', 'reference'], ['mobileImageAlt', 'text'], ['video', 'aem-content'], ['mobileVideo', 'aem-content'], ['eyebrow', 'text'], ['title', 'text'], ['description', 'richtext'], ['note', 'text'], ['metrics', 'textarea'], ['link', 'aem-content'], ['linkText', 'text'], ['linkType', 'select']],
