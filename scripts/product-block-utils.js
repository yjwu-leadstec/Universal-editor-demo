...
const PRODUCT_MODEL_FIELDS = {
  ...
  'lixiang-product-full-screen-intro': [['id', 'text', 'ID'], ['eyebrow', 'text', 'Eyebrow'], ['title', 'text', 'Title'], ['mobileTitle', 'text', 'Mobile Title Override'], ['description', 'richtext', 'Description'], ['note', 'text', 'Footnote'], ['image', 'reference', 'Desktop Poster / Background (Default)'], ['imageAlt', 'text', 'Desktop Image Alt Text'], ['mobileImage', 'reference', 'Mobile Poster / Background (Optional Override)'], ['mobileImageAlt', 'text', 'Mobile Image Alt Text'], ['video', 'reference', 'Desktop Preview Video URL (Default)'], ['mobileVideo', 'reference', 'Mobile Preview Video URL (Optional Override)'], ['fullVideo', 'reference', 'Full Video URL'], ['playLabel', 'text', 'Full Video Button Text'], ['loop', 'boolean', 'Loop Preview Video'], ['showVideoControl', 'boolean', 'Show Video Control'], ['showProgress', 'boolean', 'Show Video Progress']],
  ...
  'lixiang-product-image-switcher': [['id', 'text', 'ID'], ['eyebrow', 'text', 'Eyebrow'], ['title', 'text', 'Desktop Title'], ['mobileTitle', 'text', 'Mobile Title Override'], ['description', 'richtext', 'Description'], ['accentColor', 'text', 'Indicator Color'], ['autoPlay', 'boolean', 'Autoplay'], ['interval', 'number', 'Autoplay Interval (seconds)'], ['showVideoControl', 'boolean', 'Show Video Control'], ['showProgress', 'boolean', 'Show Video Progress']],
  'lixiang-product-image-switcher-item': [['image', 'reference', 'Desktop Poster / Image'], ['imageAlt', 'text', 'Desktop Image Alt Text'], ['mobileImage', 'reference', 'Mobile Poster / Image'], ['mobileImageAlt', 'text', 'Mobile Image Alt Text'], ['video', 'reference', 'Desktop Video URL'], ['mobileVideo', 'reference', 'Mobile Video URL'], ['label', 'text', 'Switcher Label'], ['title', 'text', 'Overlay Title'], ['description', 'richtext', 'Overlay Description'], ['value', 'text', 'Metric Value'], ['unit', 'text', 'Metric Unit'], ['note', 'text', 'Note']],
  'lixiang-product-big-small-gallery': [['id', 'text', 'ID'], ['eyebrow', 'text', 'Eyebrow'], ['title', 'text', 'Desktop Title'], ['mobileTitle', 'text', 'Mobile Title Override'], ['description', 'richtext', 'Description'], ['videoLink', 'aem-content', 'Optional Video Link'], ['videoLinkText', 'text', 'Video Link Text'], ['showVideoControl', 'boolean', 'Show Video Controls'], ['showProgress', 'boolean', 'Show Video Progress'], ['enableMotion', 'boolean', 'Enable Reveal Motion']],
  'lixiang-product-big-small-gallery-stat': [['eyebrow', 'text', 'Small Label'], ['value', 'text', 'Value'], ['unit', 'text', 'Unit'], ['description', 'richtext', 'Description']],
  'lixiang-product-big-small-gallery-item': [['image', 'reference', 'Desktop Poster / Image'], ['imageAlt', 'text', 'Desktop Image Alt Text'], ['mobileImage', 'reference', 'Mobile Poster / Image'], ['mobileImageAlt', 'text', 'Mobile Image Alt Text'], ['video', 'reference', 'Desktop Video URL'], ['mobileVideo', 'reference', 'Mobile Video URL'], ['title', 'text', 'Card Title'], ['description', 'richtext', 'Card Description'], ['link', 'aem-content', 'Link'], ['linkText', 'text', 'Link Text'], ['linkType', 'select', 'Link Type']],
  ...
  'lixiang-product-color-full-screen-slider-item': [['name', 'text', 'Color Name'], ['swatch', 'reference', 'Swatch / Material'], ['swatchAlt', 'text', 'Swatch Alt Text'], ['colorValue', 'text', 'CSS Color'], ['image', 'reference', 'Desktop Vehicle Image'], ['imageAlt', 'text', 'Desktop Image Alt Text'], ['mobileImage', 'reference', 'Mobile Vehicle Image'], ['mobileImageAlt', 'text', 'Mobile Image Alt Text']],
  ...
  'lixiang-product-text-columns': [['id', 'text', 'ID'], ['title', 'text', 'Desktop Title'], ['mobileTitle', 'text', 'Mobile Title Override'], ['description', 'richtext', 'Description']],
  'lixiang-product-text-columns-item': [['title', 'text', 'Column Title'], ['text', 'richtext', 'Column Text']],
  ...
  'lixiang-product-icon-overlay-showcase': [['id', 'text', 'ID'], ['title', 'text', 'Desktop Title'], ['mobileTitle', 'text', 'Mobile Title Override'], ['description', 'richtext', 'Description']],
  'lixiang-product-icon-overlay-showcase-panel': [['panelKey', 'text', 'Panel Key'], ['title', 'text', 'Panel Title'], ['description', 'richtext', 'Panel Description'], ['image', 'reference', 'Desktop Background'], ['imageAlt', 'text', 'Desktop Image Alt Text'], ['mobileImage', 'reference', 'Mobile Background'], ['mobileImageAlt', 'text', 'Mobile Image Alt Text'], ['mask', 'reference', 'Desktop Mask'], ['mobileMask', 'reference', 'Mobile Mask'], ['maskAlt', 'text', 'Mask Alt Text']],
  'lixiang-product-icon-overlay-showcase-hotspot': [['label', 'text', 'Label'], ['description', 'richtext', 'Description'], ['icon', 'reference', 'Icon'], ['iconAlt', 'text', 'Icon Alt Text'], ['x', 'number', 'Desktop X (%)'], ['y', 'number', 'Desktop Y (%)'], ['mobileX', 'number', 'Mobile X (%)'], ['mobileY', 'number', 'Mobile Y (%)']],
  ...
  'lixiang-product-param-cta': [['id', 'text', 'ID'], ['title', 'text', 'Desktop Title'], ['mobileTitle', 'text', 'Mobile Title Override'], ['description', 'richtext', 'Description'], ['image', 'reference', 'Desktop Vehicle Image'], ['imageAlt', 'text', 'Desktop Image Alt Text'], ['mobileImage', 'reference', 'Mobile Vehicle Image'], ['mobileImageAlt', 'text', 'Mobile Image Alt Text'], ['link', 'aem-content', 'Primary Link'], ['linkText', 'text', 'Primary Link Text'], ['linkType', 'select', 'Primary Link Type'], ['secondaryLink', 'aem-content', 'Secondary Link'], ['secondaryLinkText', 'text', 'Secondary Link Text'], ['secondaryLinkType', 'select', 'Secondary Link Type']],
  ...
  'lixiang-product-download': [['id', 'text', 'ID'], ['title', 'text', 'Title'], ['description', 'richtext', 'Description'], ['image', 'reference', 'Desktop Background'], ['imageAlt', 'text', 'Desktop Image Alt Text'], ['mobileImage', 'reference', 'Mobile Background'], ['mobileImageAlt', 'text', 'Mobile Image Alt Text'], ['iosLink', 'aem-content', 'iOS App Store Link'], ['iosLinkText', 'text', 'iOS Link Text'], ['iosLinkType', 'select', 'iOS Link Type'], ['androidLink', 'aem-content', 'Android Download Link'], ['androidLinkText', 'text', 'Android Link Text'], ['androidLinkType', 'select', 'Android Link Type']],
};
...
const PRODUCT_COLLECTION_MODELS = {
  ...
  'lixiang-product-intro-slider': 'lixiang-product-intro-slider-slide',
  ...
  'lixiang-product-image-switcher': 'lixiang-product-image-switcher-item',
  'lixiang-product-big-small-gallery': (row) => (row.children.length <= 4 ? 'lixiang-product-big-small-gallery-stat' : 'lixiang-product-big-small-gallery-item'),
  ...
  'lixiang-product-text-columns': 'lixiang-product-text-columns-item',
  ...
  'lixiang-product-icon-overlay-showcase': 'lixiang-product-icon-overlay-showcase-panel',
  'lixiang-product-icon-overlay-showcase-panel': 'lixiang-product-icon-overlay-showcase-hotspot',
