...
export default function decorate(block) {
  ...
  const items = modelItems(block, 'about-design-card');
  ...
  items.forEach((item) => {
    ...
    card.className = 'about-design-card';

    const media = document.createElement('div');
    media.className = 'about-design-card-media';
    if (picture) {
    ...
    overlay.className = 'about-design-card-overlay';

    const content = document.createElement('div');
    content.className = 'about-design-card-content';
    if (cardTitle) {
