...
export default function decorate(block) {
  ...
  inner.className = 'lixiang-about-dual-panel-inner';

  const header = document.createElement('div');
  header.className = 'lixiang-about-dual-panel-header';
  if (title) {
  ...
  if (subtitle) {
    const desc = createRichText(propSource(block, 'subtitle'), 'lixiang-about-dual-panel-subtitle');
