...
// read as empty. Claim the leading bare cells using the same positional walk
// restorePublishedModel uses, including its type check -- delivery omits cells
// for empty values, so a blind index-to-field mapping would slide later fields
// onto the wrong cells. Stop at the first child the editor already marked so
