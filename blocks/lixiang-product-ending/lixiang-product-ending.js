...
export default function decorate(block) {
  ...
  shell.className = 'lixiang-product-ending-shell';
  ...
  copy.className = 'lixiang-product-ending-copy';
  ...
  actions.className = 'lixiang-product-ending-actions';
  ...
  revealElements(block, '.lixiang-product-ending-copy');
}
