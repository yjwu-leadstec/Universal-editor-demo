...
const MODEL_FIELDS = {
  ...
  'official-center-field': [['cardKey', 'text'], ['label', 'text'], ['value', 'richtext'], ['link', 'aem-content']],
...
export default function decorate(block) {
  ...
  const linkSource = propSource(rows, 'link') || headerRows.map((row) => row.querySelector('a')).find(Boolean);
