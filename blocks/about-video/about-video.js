...
export default function decorate(block) {
  ...
  inner.className = 'about-video-inner';

  const header = document.createElement('div');
  header.className = 'about-video-header';
  if (title) {
  ...
  if (ctaText) {
    ...
    cta.type = 'button';
    cta.className = 'about-video-cta';
    const label = document.createElement('span');
    label.textContent = ctaText;
    cta.append(label);
    if (videoUrl) {
      const icon = document.createElement('span');
      icon.className = 'about-video-cta-icon';
      icon.setAttribute('aria-hidden', 'true');
      cta.append(icon);
      cta.addEventListener('click', () => {
        const dialog = document.createElement('dialog');
        dialog.className = 'about-video-dialog';
  ...
  media.className = 'about-video-media';
  if (picture) {
