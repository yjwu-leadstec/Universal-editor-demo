...
**优先级 P1** · 对应 block：`lixiang-highlight-carousel` → 子项 `highlight-slide`
...
| 轮播 Banner | `lixiang-highlight-carousel → highlight-slide` | 主题×间距；卡 `linkType` | 2.35:1、5s 自动、指示器热区 |
