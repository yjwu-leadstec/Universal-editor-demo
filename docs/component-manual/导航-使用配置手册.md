...
| Dropdown Link Card | Link Card Title、Target Page or URL、Card Background Image、Vehicle Foreground Image、Short Description | 给最近的一级菜单/分组新增卡片；背景图和可选透明底整车前景分别从 DAM 选择，不再依赖图片选择顺序 |
